      ...
      <div className="flex-1 px-6 py-10">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <Link
              to="/book-resource"
              className="group rounded-3xl border border-slate-200 bg-white p-8 shadow-sm transition hover:shadow-md"
            >
              ...
              <div className="mt-6 flex items-center gap-2 font-semibold text-[#61CE70]">
                Go to Booking Form
                <ArrowRight
                  size={18}
